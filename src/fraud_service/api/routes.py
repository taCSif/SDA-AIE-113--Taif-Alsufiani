...
TODO (Lab 2a, Part A3 — ~15 min):
Implement /v1/predict, /v1/health (liveness — NO I/O), /v1/ready
(readiness — checks the model is loaded).
...
Try it after implementing (Part A4, ~10 min): run
`make serve`, open /docs, and try: one valid request, one request with
a negative amount, one request with an unknown field. All three should
behave exactly as the Module 2 slides describe.
"""

# TODO: implement get_scorer(), the /predict, /health and /ready routes.
