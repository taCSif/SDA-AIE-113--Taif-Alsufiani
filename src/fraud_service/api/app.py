...
TODO (Lab 2a, Part A2 — ~15 min):
Build the FastAPI app factory. The model loads in `lifespan`, ONCE,
with a warm-up call — never at import time, never per-request.
...
IMPORTANT: app.state.scorer must be set ONLY after the warm-up call
completes — /ready in routes.py depends on this ordering.
"""

# TODO: implement lifespan(), create_app(), and export `app = create_app()`.
